...
# =====================================================================
# 💡 3-in-1 BRAINSTORM POLL SYSTEM (ระบบแก้บั๊กปุ่มล้มเหลวแล้ว ค๊าา!)
# =====================================================================
...
async def on_ready(): 
    ...
    # 📝 ลงทะเบียน Persistent Views ทั้งหมดให้จดจำปุ่มหลังบอทรีสตาร์ท
    bot.add_view(DynamicGroupJoinView(role_id=0, emoji_str="🌸"))
    bot.add_view(LiveBrainstormPollView()) # 🌟 แก้ไข: ตัวลงทะเบียนถาวรทำให้กดปุ่มเพิ่มไอเดียไม่ล้มเหลวแล้วจ้าา!
