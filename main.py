...
# ==========================================
# 🔓 FIXED: DYNAMIC GROUP ROLE VIEW (Ephemeral หายเอง 100%)
# ==========================================
class DynamicGroupJoinView(discord.ui.View):
    ...
    async def button_callback(self, interaction: discord.Interaction):
        # 🤫 ส่งสัญญาณแรกแบบเห็นคนเดียวค๊าา
        ...
        # 👑 แก้ไขย้ำตัวล็อกให้เด้งบอกคนเดียวและหายไปเองเมื่อกดปิดเรียบร้อยค๊าา!
        try:
...
class BotCommandControlSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        author = self.view.author # ดึงค่าเจ้าของคำสั่งจากเมนูหลัก
...
class BotControlMenuView(discord.ui.View):
    ...
    # 🔒 ตัวดักจับความปลอดภัยชั้นที่ 1 (เมนูหลัก)
...
# ==========================================
# 🎮 ROBLOX DATA AND LINK VAULT SYSTEM (🔒 ล็อกสิทธิ์)
# ==========================================
...
class RobloxServerSelect(discord.ui.Select):
    def __init__(self):
        ...
        super().__init__(placeholder="🎮 เลือกเกมที่แก๊งเราเปิดเซิร์ฟวีไว้เพื่อวาร์ป...")
...
# ==========================================
# 🛡️ INTERIOR MULTI-ROLE & USER REQUESTS (🔒 ล็อกสิทธิ์)
# ==========================================
...
class RoleSelect(discord.ui.Select):
    def __init__(self, guild):
        ...
        super().__init__(placeholder="🎨 เลือกยศทั่วไปที่คุณต้องการกดรับด้วยตัวเอง...")
...
async def on_ready(): 
    ...
    logger.info(f"✨ Doro 900+ Full-scale Engine is ONLINE as {bot.user} with Sweet Guard Style! ✨")

@bot.event
async def on_interaction(interaction: discord.Interaction):
    custom_id = interaction.data.get("custom_id", "")
    
    # 📊 ระบบลงคะแนนโพล (ทุกคนมีสิทธิ์โหวต)
    ...
    # 🔨 ระบบสภาโหวตเตะคนดื้อ (ทุกคนมีสิทธิ์ร่วมโหวตเตะ)
...
async def on_message(message: discord.Message):
    ...
    # 🎛️ เรียกใช้หน้าต่างสั่งงานหลัก (ส่ง message.author เข้าไปล็อกสิทธิ์ด้วย)
    ...
    # 🐈‍⬛ แผงสร้างปุ่มรับยศของทีมงานแอดมิน
