...
# ==========================================
# 🎮 ROBLOX UI COMPONENTS (CHECKED & SAFE)
# ==========================================
class AddRobloxServerModal(discord.ui.Modal, title="🎮 เพิ่ม/แก้ไข ลิงก์เซิร์ฟเวอร์วี"):
    def __init__(self):
        super().__init__()
        # ตรวจสอบและปรับปรุงความยาวของ Label ทุกฟิลด์ ไม่ให้เกิน 45 ตัวอักษร
        self.game_id = discord.ui.TextInput(
            label="รหัสเกม (อังกฤษตัวพิมพ์เล็ก ห้ามเว้นวรรค)", # 41 ตัวอักษร - PASS
            placeholder="เช่น blox_fruits, bedwars",
            style=discord.TextStyle.short,
            required=True
        )
        self.game_name = discord.ui.TextInput(
            label="ชื่อเกมที่จะแสดงบนเมนู (ใส่ อีโมจิ ได้)", # 40 ตัวอักษร - PASS
            placeholder="เช่น 🏴‍☠️ Blox Fruits (เซิร์ฟหลัก)",
            style=discord.TextStyle.short,
            required=True
        )
        self.game_url = discord.ui.TextInput(
            label="ลิงก์ Private Server (Roblox URL)", # 39 ตัวอักษร - PASS
...
class DeleteRobloxServerModal(discord.ui.Modal, title="🗑️ ลบลิงก์เซิร์ฟเวอร์วี"):
    def __init__(self):
        super().__init__()
        self.game_id = discord.ui.TextInput(
            label="พิมพ์รหัสเกมที่ต้องการลบ (ภาษาอังกฤษ)", # 41 ตัวอักษร - PASS
...
# ==========================================
# 🛡️ ROLE MANAGEMENT SYSTEM (CHECKED & SAFE)
# ==========================================
...
class TextInputModal(discord.ui.Modal, title="📝 ส่งเหตุผลอ้อน ๆ เพื่อขอยศพิเศษ"):
    def __init__(self):
        ...
        self.reason = discord.ui.TextInput(
            label="เหตุผล/ชื่อยศพิเศษที่อยากได้ค๊าา", # 32 ตัวอักษร - PASS
...
# ==========================================
# 📊 [FIXED 100%] POLL UI SYSTEM (DOUBLE CHECKED)
# ==========================================
class AskQuestionTextModal(discord.ui.Modal):
    def __init__(self, parent_view):
        ...
        # ตรวจสอบความยาวตัวอักษรของ Label ทุกชิ้นอย่างถี่ถ้วน
        self.question = discord.ui.TextInput(
            label="หัวข้อคำถามโพลนี้คืออะไรเอ่ย?", # 30 ตัวอักษร - PASS
            style=discord.TextStyle.short, 
            placeholder="เย็นนี้ไปกินชาบูกันไหมค๊าา?",
            required=True
        )
        self.choices_input = discord.ui.TextInput(
            label="ตัวเลือกคำตอบ (แยกด้วยเครื่องหมาย , น้าา)", # 41 ตัวอักษร - PASS ชัวร์! ไม่เกิน 45 แล้ว
            style=discord.TextStyle.paragraph, 
