...
# ==========================================
# 🎮 ROBLOX UI COMPONENTS (เวอร์ชั่นแก้ไข Interaction Failed)
# ==========================================
class AddRobloxServerModal(discord.ui.Modal, title="🎮 เพิ่ม/แก้ไข ลิงก์เซิร์ฟเวอร์วี"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        # สร้าง View ใหม่มารองรับเมนูที่อัปเดตแล้วทันที
...
class RobloxServerView(discord.ui.View):
    def __init__(self):
        # ปรับ timeout เป็น None เพื่อป้องกันไม่ให้ปุ่มหมดอายุจนกดไม่ได้ (แก้ Interaction Failed)
        super().__init__(timeout=None)
